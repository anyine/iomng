Ext.define('VMS.controller.DispatchCarFormCtrl', {
	extend : 'Ext.app.Controller',
	views : [ 'dispatchCarForm.List' ],
	stores : [ 'DispatchCarFormStore' ],
	models : [ 'DispatchCarForm' ],

	init : function() {
		console.log('dispatchCarForm controller init...');
//		this.control({
